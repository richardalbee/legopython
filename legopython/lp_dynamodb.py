...
def sortkey_search(partition_key_name:str, partition_key_value:str,sort_key_name:str, sort_key_prefix_value:list, dynamo_tablename:str, aws_region='us-east-2') -> list:
    ...
    for sort_key_value in deduped_sort_key_list:
        ...
        if response['Items'] != []:
            for search_result in response['Items']: #TODO: Decide how to handle more than one search result per query:
...
def delete_indices(partition_key_name:str, partition_key_value:str, sort_key_name:str, sort_key_value:list, table_name:str, aws_region='us-east-2') -> None:
